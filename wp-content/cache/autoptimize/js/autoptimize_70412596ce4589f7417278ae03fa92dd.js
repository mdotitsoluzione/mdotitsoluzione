  ...
  $.extend(Plugin.prototype, {
    ...
    initSlideshow: function () {
      ...
      for (i = 0; i < this.numSlides; i++) {
        ...
        $slide
          .css({ "background-image": "url('" + this.settings.src[i] + "')" })
          .appendTo($slidesWrap);
        ...
        if (i == 0) {
          ...
          $(".zs-enabled .ltx-zs-slider-inner.ltx-zs-slide-" + i).addClass(
            "visible"
          );
        }
      }
      ...
      if (this.settings.arrows == true) {
        $(
          '<div class=""><span class="ltx-arrow-right">' +
            this.settings.next +
            '</span><span class="ltx-arrow-left">' +
            this.settings.prev +
            "</span></div>"
        ).appendTo($arrowsWrap);
    ...
    initSingle: function () {
      ...
      $slide
        .css({ "background-image": "url('" + this.settings.src[0] + "')" })
        .appendTo($slidesWrap);
      $slide.addClass("active").css("opacity", 1);
    ...
    jump: function (pos) {
      ...
      $(".zs-enabled .ltx-zs-slider-inner.ltx-zs-slide-" + pos).addClass(
        "visible"
      );
      if (this.support) {
        this.switching = true;
